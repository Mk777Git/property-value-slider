export default class ContentSlider extends HTMLElement {
  ...
  getParameter() {
    ...
    this.showMinMax = this.getAttribute('showMinMax') == null ? false : true;
    ...
    this.destPropertyName = this.getAttribute('destPropertyName');
    this.destPropertyUnit = this.getAttribute('destPropertyUnit') === null ? '' : this.getAttribute('destPropertyUnit');
  }
